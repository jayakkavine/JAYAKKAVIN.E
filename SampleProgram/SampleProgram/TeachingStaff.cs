...
namespace SampleProgram
{
    class TeachingStaff : StaffDetails
    {
        ...
        public TeachingStaff(string college_name, string college_address, int emp_no, int age, string emp_name, string address, string dept, 
            double basic_salary, int da, int hra, int cca, int pf)
